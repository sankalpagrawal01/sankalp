...
public class CalculatorControllerMethodTest {
    ...
    public void addTest(){
        ...
        double result= calculatorController.addition(3.0f,4.0f);
    ...
    public void subTest(){
        MyCalculator calculator=new MyCalculator();
        calculatorController=new CalculatorController(calculator);
        double result= calculatorController.subtraction(8.0f,4.0f);
    ...
    public void mulTest(){
        MyCalculator calculator=new MyCalculator();
        calculatorController=new CalculatorController(calculator);
        double result= calculatorController.multiplication(3.0f,4.0f);
    ...
    public void divTest(){
        MyCalculator calculator=new MyCalculator();
        calculatorController=new CalculatorController(calculator);
        double result= calculatorController.division(12.0f,4.0f);
